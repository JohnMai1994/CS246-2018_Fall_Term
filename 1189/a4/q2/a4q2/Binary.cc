...
Binary &Binary::operator= (const Binary &other){
    l_part = new other.l_part;
    r_part = new other.r_part;
    method = other.method;
    return *this;
}
*/
Binary::Binary(const Binary &other): method(other.method) ,l_part{other.l_part->copy()}, r_part{other.r_part->copy()}{}

Binary * Binary::copy() const {
     //cout << "it work Binary" << endl;
